# TC-077: POST /api/v1/auth/reset-password
...
## 影响范围
此BUG导致POST /api/v1/auth/reset-password功能完全无法使用，严重影响用户体验和系统可用性。
...
## 详细错误日志
```
密码重置API集成测试 › POST /api/v1/auth/reset-password › 正常场景 - 有效token重置密码成功
    ...
    > 41 |       expect(response.status).toBe(200);
      ...
      43 |       expect(response.body.message).toContain('密码重置成功');
      44 |     });

      at Object.toBe (tests/integrati...
```
