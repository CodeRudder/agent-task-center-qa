# TC-050: GET /api/v1/reports/trend
...
## 影响范围
此BUG导致GET /api/v1/reports/trend功能完全无法使用，严重影响用户体验和系统可用性。
...
## 详细错误日志
```
趋势分析报表API集成测试 › GET /api/v1/reports/trend › 正常场景 - 获取趋势分析报表成功
    ...
    > 37 |       expect(response.status).toBe(200);
      ...
      39 |       expect(response.body.data).toHaveProperty('trendData');
      40 |     });

      at Object.toBe (tests/integration/...
```
